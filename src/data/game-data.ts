...
export const bonusCards: BonusCard[] = [
  { id: 'campaign1', type: 'Campaign', name: '텀블러 챌린지', description: '효과: 텀블러 사용 시 친환경 +3' },
  { id: 'campaign2', type: 'Campaign', name: '로컬푸드 지지자', description: '효과: 로컬/수제 아이템 구매 시 친환경 +2' },
  { id: 'campaign3', type: 'Campaign', name: '지구지킴이 인증', description: '효과: 최종 친환경 10점 이상이면 맛+1, 편리+1' },
  { id: 'campaign4', type: 'Campaign', name: '물 절약 캠페인', description: '효과: 일회용 생수 미구매 시 친환경 +2' },
  { id: 'campaign5', type: 'Campaign', name: '비닐 제로 선언', description: '효과: 과대포장 제품 미구매 시 친환경 +3' },
  { id: 'tax1', type: 'Tax', name: '플라스틱세 부과', description: '페널티: 일회용 플라스틱 용기 구매 시 맛-1, 편리-1' },
  { id: 'tax2', type: 'Tax', name: '페트병 규제', description: '페널티: 페트병 음료 구매 시 씨앗 1개 차감 (현재 미적용)' },
  { id: 'tax3', type: 'Tax', name: '과대포장 벌금', description: '페널티: 과대포장 제품 구매 시 친환경 -3' },
  { id: 'tax4', type: 'Tax', name: '탄소발자국 경고', description: '페널티: 수입 식품 2개 이상 구매 시 총점 -2' },
  { id: 'tax5', type: 'Tax', name: '일회용품 페널티', description: '페널티: 일회용품 2개 이상 구매 시 소비 점수 -3 (현재 미적용)' },
];
